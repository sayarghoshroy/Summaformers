...
def get_command(file):
    topk = file.split('_')[-1]
    if topk == '0' : return -1
    return "python main_parallel.py -batch_size 1 -device 0 -predict -filename " + file + " -topk " + topk + " -load_dir checkpoints_arxiv/XXX_pubmed_newpubmed.ptCNN_RNN_seed_1.pt"
